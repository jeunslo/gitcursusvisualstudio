...
namespace OefeningOpPizza
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            ////***Alle ToString() gerechten uittesten***
            ...
            ////***BesteldeGerechten ToString() uittesten***
            //Gerecht eenGerecht = new Pizza("Margharita", 8m, new List<string>() { "Tomatensaus", "Mozzarella" });
            //var extra = new List<BesteldGerecht.Extra>
            //{
            //    BesteldGerecht.Extra.Kaas,
            //    BesteldGerecht.Extra.Look
            //};
            //BesteldGerecht eenGroot = new BesteldGerecht(eenGerecht, BesteldGerecht.Grootte.Groot, extra);
            //Console.WriteLine(eenGroot);


            ////***Drank ToString() uittesten****
            //try
            //{
            //    var dranken = new List<Drank>
            //    {
            //    new Frisdrank { Naam = Drank.Drankverzameling.Cocacola },
            //    new Frisdrank { Naam = Drank.Drankverzameling.Limonade },
            //    new Frisdrank { Naam = Drank.Drankverzameling.Water },
            ...
            ////***Klant uittesten***
            //Klant[] ik = new Klant[2];
            //ik[0] = new Klant("1");
            //ik[1] = new Klant("2");

            //foreach (Klant klant in ik)
            //    Console.WriteLine(klant);

            ////*******Bestellingen uittesten*********

            //Bestellingen bestellingen = new Bestellingen();
            //bestellingen.Klant = new Klant();
            //bestellingen.Aantal = 1;
            //Console.WriteLine(bestellingen);

            //***********Klanten Wegschrijven + lezen uittesten***************
            //Klant klantbestand = new Klant();
            //List<Klant> klant = klantbestand.KlantLezen();
            //klant.Add(new Klant("Jan Janssen6"));
            //klant.Add(new Klant("Piet Peeters6"));
            ...
            try
            {
                ...
                Klant klantbestand = new Klant();
                List<Klant> klanten = klantbestand.KlantLezen();
                while (keuze != "STOP")
                {
